...
//@Route(value = TilesViewOld.ENTER_TILES, layout = MainView.class)
public class TilesViewOld /*extends VerticalLayout implements BeforeLeaveObserver */{
//
//    static final String ENTER_TILES = "tilesCheck";
//
...
//
//    @Autowired
//    public TilesViewOld(TilesRepository tilesRepository, GutterRepository gutterRepository) {
