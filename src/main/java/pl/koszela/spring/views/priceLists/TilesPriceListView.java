...
public class TilesPriceListView extends VerticalLayout implements PriceListInterface<Tiles> {
    ...
    public TilesPriceListView(TilesRepository tilesRepository) {
        ...
        add(createButtonToDiscounts(save, allTilesRepo, dialog, grid, tilesRepository));
        add(createGridd());
        add(saveToRepo());
    }
    ...
    public Grid<Tiles> createGridd() {
        ...
        PriceListInterface.super.createGrid(grid, binder, allTilesRepo, tilesRepository);
//        Grid.Column<Tiles> priceListNameColumn = grid.addHierarchyColumn(Tiles::getManufacturer).setHeader("Nazwa Cennika");
