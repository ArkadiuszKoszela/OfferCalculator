...
import static app.views.Checkboxes.CHECKBOXES;
import static app.views.EnterTiles.ENTER_TILES;
...
public class MainView extends AppLayout {
    ...
    private Tab checkboxes() {
        final Span label = new Span(getTranslation(CHECKBOXES));
    ...
    private Tab enterTiles() {
        final Span label = new Span(getTranslation(ENTER_TILES));
        final Icon icon = TRENDING_UP.create();
